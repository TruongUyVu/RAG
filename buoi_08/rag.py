"""
=============================================================================
BUỔI 08: SEMANTIC RAG BASELINE (KẾ THỪA TỪ BUỔI 07)
=============================================================================
Nguồn gốc: Sao chép từ rag_foundation/buoi_07/rag.py làm baseline đối chứng.
Mục đích: Cung cấp pipeline Semantic Retrieval đơn thuần (Gemini Embeddings + ChromaDB)
để so sánh hiệu năng với Advanced Hybrid RAG (BM25 + Dense + RRF + Reranker) tại Buổi 08.
Cấu hình và Lưu trữ: Tự động sử dụng .env và storage/ của Buổi 08 via Path(__file__).
=============================================================================
"""
